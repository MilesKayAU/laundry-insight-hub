...
const FaqPage = () => {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is PVAFree.com?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "PVAFree.com is a free, independent, community-driven database that investigates whether household detergent products contain Polyvinyl Alcohol (PVA) — a synthetic plastic polymer that dissolves in water but may not fully biodegrade. Many brands market their products as 'plastic-free', but use PVA-based film in laundry sheets and pods. Our goal is to cut through the confusion by collecting ingredient data, scientific findings, and community contributions to help consumers make better-informed choices."
        }
      },
      {
        "@type": "Question",
        "name": "Is PVAFree.com completely free?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes — PVAFree.com is a voluntary, public-access project, similar in spirit to Wikipedia. You can browse listings, see verified ingredient details, submit new products or corrections, and read research and FAQ content. The only paid offering is our Certified PVA-Free badge, which eligible brands may license for product packaging and marketing."
        }
      },
      {
        "@type": "Question",
        "name": "Why do companies say 'Plastic-Free' if their products contain PVA?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Many brands promote their product as plastic-free because they have no plastic packaging — but the product itself (e.g., a laundry sheet or pod) may contain PVA (Polyvinyl Alcohol), which is classified as a plastic polymer by the US Environmental Protection Agency (EPA), European Chemicals Agency (ECHA), and Organisation for Economic Co-operation and Development (OECD). Since PVA dissolves in water, some companies argue it's 'not plastic' — but dissolving doesn't equal biodegrading, water treatment plants may not break down all PVA, and residuals can enter waterways and persist in ecosystems."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>FAQ - Understanding PVA in Laundry Products | PVAFree.com</title>
        <meta name="description" content="Learn about PVA (polyvinyl alcohol) in laundry sheets and pods. Answers to frequently asked questions about plastic-free claims, environmental impact, and our certification process." />
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-2 text-science-800">
            Frequently Asked Questions About PVA in Laundry Products
          </h1>
          <p className="text-xl text-center mb-12 text-gray-600">
            Everything You Need to Know About PVA, Laundry Products, and Our Certification Process
          </p>
